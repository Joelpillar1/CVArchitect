...
const FreshGrad8Template: React.FC<FreshGrad8TemplateProps> = ({ data }) => {
    ...
    <div className={`section-header-wrap break-inside-avoid w-full mb-2 ${getSectionHeaderAlignment()}`}>
      ...
      <div
        ...
        style={{
          width: '100%',
          height: '1.5px',
          backgroundColor: data.accentColor || '#1f2937',
          marginTop: '3px',
          marginBottom: '4px',
        }}
      />
  ...
  return (
    <div
      className="resume-content flex flex-col w-full h-full bg-white relative text-gray-900"
      style={{
        lineHeight: data.lineHeight || 1.5,
        fontSize: `${bodySize}pt`,
          ...
          if (data.location || data.address) {
            contactItems.push(
              <span key="loc" className="inline-flex items-center gap-1">
                {showIcons && <MapPin size={11} className="shrink-0" />}
          ...
          if (data.phone) {
            contactItems.push(
              <span key="ph" className="inline-flex items-center gap-1">
                {showIcons && <Phone size={11} className="shrink-0" />}
          ...
          if (data.email) {
            contactItems.push(
              <span key="em" className="inline-flex items-center gap-1">
                {showIcons && <Mail size={11} className="shrink-0" />}
          ...
          if (data.linkedin) {
            contactItems.push(
              <span key="li" className="inline-flex items-center gap-1">
                {showIcons && <Linkedin size={11} className="shrink-0" />}
                <a
                  data-path="linkedin"
          ...
          if (data.atHandle) {
            contactItems.push(
              <span key="at" className="inline-flex items-center gap-1">
                {showIcons && <Send size={11} className="shrink-0" />}

            ...
            {data.education.map((edu) => (
              <div key={edu.id} className="break-inside-avoid" style={bodyStyle}>
                ...
                <div className="italic text-gray-900">
                  <RichText text={edu.degree || 'Bachelor of Arts in Major; Minor in Field'} />
                </div>
            ...
            {data.experience.map((exp) => (
              <div key={exp.id} className="break-inside-avoid" style={bodyStyle}>
                <div className="flex justify-between items-baseline mb-0.5">
                  <div className="text-gray-900">
                    <span className="font-semibold"><RichText text={exp.company ?? ''} /></span>
                ...
                {exp.role && (
                  <div className="italic text-gray-900 mb-0.5">
